...
import static org.vertexium.elasticsearch7.Elasticsearch7SearchIndex.AGGREGATION_HAS_NOT_SUFFIX;
    ...
    private static GeohashResult reduceGeohashResults(ElasticsearchSearchQueryBase query, List<Aggregation> aggs) {
        ...
        for (Aggregation agg : aggs) {
            if (agg instanceof GeoGrid) {
                ...
                throw new VertexiumException("Aggregation is not a geogrid: " + agg.getClass().getName());
            }
        }
