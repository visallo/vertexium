...
public class SaveResult<T extends Element> extends CompletableFuture<T> {
    ...
    /**
     * Future that is completed when the in-memory representation of the element is ready. This does not indicate
     * that the element has been saved and flushed to disk.
     */
