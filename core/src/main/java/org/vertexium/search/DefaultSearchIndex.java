...
public class DefaultSearchIndex implements SearchIndex {
    ...
    @Override
    public <TElement extends Element> CompletableFuture<Void> updateElement(Graph graph, ExistingElementMutation<TElement> mutation, Authorizations authorizations) {
