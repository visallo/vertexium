...
public interface Graph {
    ...
    default Element getElement(ElementId elementId, User user) {
        switch (elementId.getElementType()) {
            case EDGE:
                return getEdge(elementId.getId(), user);
            case VERTEX:
                return getVertex(elementId.getId(), user);
            default:
    ...
    default Element getElement(ElementId elementId, FetchHints fetchHints, User user) {
        ...
        switch (elementId.getElementType()) {
            case VERTEX:
                return getVertex(elementId.getId(), fetchHints, user);
            case EDGE:
                return getEdge(elementId.getId(), fetchHints, user);
            default:
                throw new VertexiumException("Unhandled element type: " + elementId.getElementType());
        }
    }
     ...
     * @return Rows
     */
    default Stream<ExtendedDataRow> getExtendedData(
        ElementType elementType,
        String elementId,
        String tableName,
        FetchHints fetchHints,
        ...
        return getExtendedData(ElementId.create(elementType, elementId), tableName, fetchHints, user);
    }
    ...
    default Iterable<ExtendedDataRow> getExtendedData(
        ...
        return toIterable(getExtendedData(elementId, tableName, fetchHints, authorizations.getUser()));
    }
    ...
    default Stream<ExtendedDataRow> getExtendedData(
        ...
        return getExtendedDataForElements(Lists.newArrayList(elementId), tableName, fetchHints, user);
    }
    ...
    default Iterable<ExtendedDataRow> getExtendedDataForElements(
        ...
        return toIterable(getExtendedDataForElements(elementIds, authorizations.getUser()));
    }
     ...
     * @return Rows
     */
    default Stream<ExtendedDataRow> getExtendedDataForElements(
        Iterable<? extends ElementId> elementIds,
        User user
    ) {
        return getExtendedDataForElements(elementIds, FetchHints.ALL, user);
    }
    ...
    default Iterable<ExtendedDataRow> getExtendedDataForElements(
        ...
        return toIterable(getExtendedDataForElements(elementIds, tableName, authorizations.getUser()));
    }
    ...
    default Stream<ExtendedDataRow> getExtendedDataForElements(
        ...
        return getExtendedDataForElements(elementIds, tableName, FetchHints.ALL, user);
    }
    ...
    default Iterable<ExtendedDataRow> getExtendedDataForElements(
        ...
        return toIterable(getExtendedDataForElements(elementIds, fetchHints, authorizations.getUser()));
    }
    ...
    default Stream<ExtendedDataRow> getExtendedDataForElements(
        ...
        return getExtendedDataForElements(elementIds, null, fetchHints, user);
    }
    ...
    default Iterable<ExtendedDataRow> getExtendedDataForElements(
        ...
        return toIterable(getExtendedDataForElements(elementIds, tableName, fetchHints, authorizations.getUser()));
    }
     ...
     * @return Rows
     */
    Stream<ExtendedDataRow> getExtendedDataForElements(
        Iterable<? extends ElementId> elementIds,
        String tableName,
        FetchHints fetchHints,
        User user
    ...
    default void deleteExtendedDataRow(ExtendedDataRowId id, User user) {
        ElementId elementId = ElementId.create(id.getElementType(), id.getElementId());
