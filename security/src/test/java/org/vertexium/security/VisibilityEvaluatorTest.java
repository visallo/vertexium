...
import static org.vertexium.security.ColumnVisibility.quote;

public class VisibilityEvaluatorTest {
    @Test
    public void testNot() throws VisibilityParseException {
        VisibilityEvaluator e = new VisibilityEvaluator(new Authorizations("a", "b"));
        assertFalse(e.evaluate(new ColumnVisibility("!a")));
        assertTrue(e.evaluate(new ColumnVisibility("a|!b")));
        assertTrue(e.evaluate(new ColumnVisibility("!a|b")));
        assertFalse(e.evaluate(new ColumnVisibility("!a|!b")));

        e = new VisibilityEvaluator(new Authorizations("aaa", "bbb"));
        assertFalse(e.evaluate(new ColumnVisibility("!aaa")));
        assertTrue(e.evaluate(new ColumnVisibility("aaa|!bbb")));
        assertTrue(e.evaluate(new ColumnVisibility("!aaa|bbb")));
        assertFalse(e.evaluate(new ColumnVisibility("aaa&!(bbb)")));
        assertFalse(e.evaluate(new ColumnVisibility("!aaa&bbb")));
        assertFalse(e.evaluate(new ColumnVisibility("!(aaa)|!bbb")));
    }
