    ...
    public Text getColumnQualifier(NameSubstitutionStrategy nameSubstitutionStrategy) {
        return new Text(
                nameSubstitutionStrategy.deflate(getPropertyName())
                        + KeyBase.VALUE_SEPARATOR + nameSubstitutionStrategy.deflate(getPropertyKey())
                        + KeyBase.VALUE_SEPARATOR + getPropertyVisibilityString()
                        + KeyBase.VALUE_SEPARATOR + getPropertyTimestamp()
                        + KeyBase.VALUE_SEPARATOR + getMetadataKey()
        );
    }
