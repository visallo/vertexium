...
public class AccumuloGraphConfiguration extends GraphConfiguration {
    ...
    public static final String USE_ROW_DEDUPLICATION_ITERATOR = "useRowDeduplicationIterator";
    ...
    public static final Boolean DEFAULT_USE_ROW_DEDUPLICATION_ITERATOR = false;
    ...
    public boolean useRowDeduplicationIterator() {
        return getBoolean(USE_ROW_DEDUPLICATION_ITERATOR, DEFAULT_USE_ROW_DEDUPLICATION_ITERATOR);
    }
}
