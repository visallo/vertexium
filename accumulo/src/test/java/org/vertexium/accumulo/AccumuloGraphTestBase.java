...
public abstract class AccumuloGraphTestBase extends GraphTestBase {
    ...
    protected Authorizations createAuthorizations(String... auths) {
        getAccumuloResource().addAuthorizations(getGraph(), auths);
     ...
     * <p>
     * ((AccumuloGraphTest)this).printVerticesTable(new AuthorizationsUser(AUTHORIZATIONS_ALL))
     */
    public void printVerticesTable(User user) {
        String tableName = getGraph().getVerticesTableName();
        printTable(tableName, user);
    }

    public void printTable(String tableName, User user) {
        System.out.println(tableName);
        try {
            Scanner scanner = getGraph().getConnector().createScanner(
                tableName,
                getGraph().toAccumuloAuthorizations(user)
            );
