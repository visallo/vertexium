...
public class IteratorHistoricalMarkPropertyHiddenEvent extends IteratorHistoricalPropertyEvent {
    private final ByteSequence hiddenVisibility;
    private final Value data;

    public IteratorHistoricalMarkPropertyHiddenEvent(
    ...
    static IteratorHistoricalEvent decode(DataInputStream in, ElementType elementType, String elementId, long timestamp) throws IOException {
        ...
        return new IteratorHistoricalMarkPropertyHiddenEvent(
            elementType,
            elementId,
            propertyKey,
            propertyName,
    ...
    protected byte getTypeId() {
        return TYPE_ID_MARK_PROPERTY_HIDDEN;
    }
}
