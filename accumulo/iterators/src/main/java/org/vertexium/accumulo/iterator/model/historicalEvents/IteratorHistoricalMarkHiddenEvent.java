...
public class IteratorHistoricalMarkHiddenEvent extends IteratorHistoricalEvent {
    private final ByteSequence hiddenVisibility;
    private final Value data;

    public IteratorHistoricalMarkHiddenEvent(
    ...
    static IteratorHistoricalEvent decode(DataInputStream in, ElementType elementType, String elementId, long timestamp) throws IOException {
        ...
        return new IteratorHistoricalMarkHiddenEvent(
            elementType,
            elementId,
            hiddenVisibility,
            timestamp,
