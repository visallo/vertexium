...
public class IteratorHistoricalAddVertexEvent extends IteratorHistoricalAddElementEvent {
    private final ByteSequence visibility;

    public IteratorHistoricalAddVertexEvent(
        String elementId,
    ...
    static IteratorHistoricalEvent decode(DataInputStream in, String elementId, long timestamp) throws IOException {
        ...
        return new IteratorHistoricalAddVertexEvent(
            elementId,
            visibility,
            timestamp
        );
