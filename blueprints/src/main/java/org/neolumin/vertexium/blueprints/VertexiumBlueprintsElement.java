...
public abstract class VertexiumBlueprintsElement implements Element {
    ...
    private final org.neolumin.vertexium.Element element;
    private final Authorizations authorizations;
    private final VertexiumBlueprintsGraph graph;

    protected VertexiumBlueprintsElement(VertexiumBlueprintsGraph graph, org.neolumin.vertexium.Element element, Authorizations authorizations) {
        this.graph = graph;
    ...
    public org.neolumin.vertexium.Element getVertexiumElement() {
        return element;
    }
