...
public enum ElasticsearchDocumentType {
    ...
    public static ElasticsearchDocumentType fromElementType(ElementType elementType) {
        switch (elementType) {
            case VERTEX:
                return VERTEX;
            case EDGE:
    ...
    public static ElasticsearchDocumentType fromSearchHit(SearchHit searchHit) {
        SearchHitField elementType = searchHit.getFields().get(FieldNames.ELEMENT_TYPE);
        if (elementType == null) {
            return null;
        }
