...
public class Elasticsearch5GraphConfiguration extends GraphConfiguration {
    ...
    public static final String RETRIES_ON_CONFLICT = "retriesOnConflict";
    public static final int RETRIES_ON_CONFLICT_DEFAULT = 10;
    ...
    public int getBulkQueueDepth() {
        return getInt(GraphConfiguration.SEARCH_INDEX_PROP_PREFIX + "." + BULK_QUEUE_DEPTH, BULK_QUEUE_DEPTH_DEFAULT);
    }

    public int getBulkCorePoolSize() {
        return getInt(GraphConfiguration.SEARCH_INDEX_PROP_PREFIX + "." + BULK_CORE_POOL_SIZE, BULK_CORE_POOL_SIZE_DEFAULT);
    }

    public int getBulkMaxPoolSize() {
        return getInt(GraphConfiguration.SEARCH_INDEX_PROP_PREFIX + "." + BULK_MAX_POOL_SIZE, BULK_MAX_POOL_SIZE_DEFAULT);
    }

    public int getBulkMaxBatchSize() {
        return getInt(GraphConfiguration.SEARCH_INDEX_PROP_PREFIX + "." + BULK_MAX_BATCH_SIZE, BULK_MAX_BATCH_SIZE_DEFAULT);
    }

    public int getBulkMaxBatchSizeInBytes() {
        return getInt(GraphConfiguration.SEARCH_INDEX_PROP_PREFIX + "." + BULK_MAX_BATCH_SIZE_IN_BYTES, BULK_MAX_BATCH_SIZE_IN_BYTES_DEFAULT);
    }

    public int getBulkMaxFailCount() {
        return getInt(GraphConfiguration.SEARCH_INDEX_PROP_PREFIX + "." + BULK_MAX_FAIL_COUNT, BULK_MAX_FAIL_COUNT_DEFAULT);
    }

    public Duration getBulkRequestTimeout() {
        return getDuration(GraphConfiguration.SEARCH_INDEX_PROP_PREFIX + "." + BULK_REQUEST_TIMEOUT, BULK_REQUEST_TIMEOUT_DEFAULT);
    }

    public int getRetriesOnConflict() {
        return getInt(GraphConfiguration.SEARCH_INDEX_PROP_PREFIX + "." + RETRIES_ON_CONFLICT, RETRIES_ON_CONFLICT_DEFAULT);
    }
}
