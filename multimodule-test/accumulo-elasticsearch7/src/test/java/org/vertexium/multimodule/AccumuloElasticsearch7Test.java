...
import org.vertexium.elasticsearch7.ElasticsearchResource;
import org.vertexium.elasticsearch7.TestElasticsearch7ExceptionHandler;
...
public class AccumuloElasticsearch7Test extends AccumuloGraphTestBase {
    @ClassRule
    public static final AccumuloResource accumuloResource = new AccumuloResource("accumulo-es7-multimodule-test", new HashMap<String, String>() {{
    ...
    @ClassRule
    public static final ElasticsearchResource elasticsearchResource = new ElasticsearchResource(AccumuloElasticsearch7Test.class.getName());
    ...
    public void testDocumentMissingHandler() throws Exception {
        TestElasticsearch7ExceptionHandler.authorizations = AUTHORIZATIONS_ALL;
